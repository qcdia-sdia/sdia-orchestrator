...
public interface UserApi {
    ...
    @RequestMapping(value = "/orchestrator/user",
    ...
    @RequestMapping(value = "/orchestrator/user/login",
        produces = { "application/json" }, 
    ...
    @RequestMapping(value = "/orchestrator/user/logout",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/orchestrator/user/{username}",
        produces = { "application/json" }, 

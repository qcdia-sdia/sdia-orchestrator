...
public interface ToscaTemplateApi {
    ...
    @RequestMapping(value = "/orchestrator/tosca_template/{id}",
    ...
    @ApiResponses(value = {
        ...
        ,
        @ApiResponse(code = 404, message = "ToscaTemplate not found")})
    @RequestMapping(value = "/orchestrator/tosca_template/all",
            method = RequestMethod.DELETE)
    ...
    @ApiResponses(value = {
        ...
        ,
        @ApiResponse(code = 405, message = "Invalid input")})
    @RequestMapping(value = "/orchestrator/tosca_template/ids",
